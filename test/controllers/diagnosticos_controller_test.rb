...
class DiagnosticosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diagnostico" do
    assert_difference('Diagnostico.count') do
      post diagnosticos_url, params: { diagnostico: { diagnostico: @diagnostico.diagnostico, hospitalizacion: @diagnostico.hospitalizacion, secuela: @diagnostico.secuela, ultima_crisis: @diagnostico.ultima_crisis } }
    end
  ...
  test "should update diagnostico" do
    patch diagnostico_url(@diagnostico), params: { diagnostico: { diagnostico: @diagnostico.diagnostico, hospitalizacion: @diagnostico.hospitalizacion, secuela: @diagnostico.secuela, ultima_crisis: @diagnostico.ultima_crisis } }
