...
class NacionalidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nacionalidad" do
    assert_difference('Nacionalidad.count') do
      post nacionalidades_url, params: { nacionalidad: { nacionalidad: @nacionalidad.nacionalidad } }
    end
  ...
  test "should update nacionalidad" do
    patch nacionalidad_url(@nacionalidad), params: { nacionalidad: { nacionalidad: @nacionalidad.nacionalidad } }
