...
class MedicamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicamento" do
    assert_difference('Medicamento.count') do
      post medicamentos_url, params: { medicamento: { adherencia_tratamiento: @medicamento.adherencia_tratamiento, autonomia_administracion: @medicamento.autonomia_administracion, dosis: @medicamento.dosis, medicamento: @medicamento.medicamento, pcd_id.integer: @medicamento.pcd_id.integer } }
    end
  ...
  test "should update medicamento" do
    patch medicamento_url(@medicamento), params: { medicamento: { adherencia_tratamiento: @medicamento.adherencia_tratamiento, autonomia_administracion: @medicamento.autonomia_administracion, dosis: @medicamento.dosis, medicamento: @medicamento.medicamento, pcd_id.integer: @medicamento.pcd_id.integer } }
